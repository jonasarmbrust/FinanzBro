"""FinanzBro - Pydantic Datenmodelle"""
...
class PortfolioPosition(BaseModel):
    ...
    def value_eur(self, eur_usd: float = 1.08, eur_dkk: float = 7.46, eur_gbp: float = 0.855) -> float:
...
class TechRecommendation(BaseModel):
    ...
    source: str = "FinanzBro Tech-Radar"     # Quellen-Label
