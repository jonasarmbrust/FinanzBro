"""FinanzBro - Zentrale Währungskonvertierung
...
from fetchers.currency import (
    ...
    DEFAULT_EUR_USD, DEFAULT_EUR_DKK, DEFAULT_EUR_GBP,
)
...
class CurrencyConverter:
    ...
    async def create(cls, eur_usd_override: Optional[float] = None) -> "CurrencyConverter":
        ...
        logger.info(
            f"💱 Wechselkurse: USD={rates.eur_usd}, DKK={rates.eur_dkk}, GBP={rates.eur_gbp}"
        )
        return cls(rates)
